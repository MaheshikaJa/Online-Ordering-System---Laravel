                              ...
                              <div class="row">
                                  <div class="col-sm-8">
                                      <div class="form-group"> <label><span class="hidden-xs">
                                          ...
                                          <div class="input-group"> <input type="number"  onfocus="this.value=''" placeholder="MM" name="" min="1" max="12" class="form-control" required> <input type="number"  onfocus="this.value=''"placeholder="YY" min="23" max="31" name="" class="form-control" required> </div>
                                      </div>
                                  </div>
                                  <div class="col-sm-4">
                                      <div class="form-group mb-4"> <label data-toggle="tooltip" title="Three digit CV code on the back of your card">
                                              <h6>CVV <i class="fa fa-question-circle d-inline"></i></h6>
                                          </label> <input type="number"  onfocus="this.value=''" required class="form-control"min="100" max="999" > </div>
                                  </div>
                              </div>
                              
                               
                                <div class="card-footer"> <button type="rest"  class="subscribe btn btn-primary btn-block shadow-sm" name="submit"> Confirm Payment </button>
                              </form>
                      </div>
                  </div> <!-- End -->
